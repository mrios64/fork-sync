...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            let pr = yield octokit.pulls.create({ owner: context.repo.owner, repo: repo, title: prTitle, head: owner + ':' + head, base: base, body: prMessage, maintainer_can_modify: false });
            yield delay(20);
            if (autoApprove) {
